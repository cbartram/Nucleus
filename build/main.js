...
var firstToCaps = function firstToCaps(string) {
...
var templateStyle = 'import React, { Component } from \'react\';\nimport \'./' + config.name + '.css\';\n\nexport default class ' + config.name + ' extends Component {\n  render() {\n      return <h1>' + config.name + '</h1>\n  }\n}';
// React template that does NOT include styles
var templateOriginal = 'import React, { Component } from \'react\';\n\nexport default class ' + config.name + ' extends Component {\n  render() {\n      return <h1>' + config.name + '</h1>\n  }\n}';

exec('cd ' + config.out + ' && mkdir ' + config.name + ' && cd ./' + config.name, function (err) {
  if (err) {
